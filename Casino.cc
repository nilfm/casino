...
//royal flush: escala de color (mateix pal)
//quads: poker
//full house: 3+2
//flush: 5 cartes del mateix pal
//straight: escala
//three: trio
//two pair: 2+2
//pair: parella
...
int main(){
    ...
    while (not end and money > 0){
        cout << endl << endl << endl << "You have " << money << " coins." << endl;
        ...
        if (choice == 0) end = true;
            ...
            else cout << "Sorry, you must have at least 5 coins to enter a game";
        }
        else{
    ...
    if (money == 0) cout << endl << "You're broke! Game over." << endl;
